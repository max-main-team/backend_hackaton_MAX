...
--
-- Name: max_users_data_id_seq; Type: SEQUENCE; Schema: users; Owner: max_superuser
--

ALTER TABLE users.max_users_data ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME users.max_users_data_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE users.refresh_tokens ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME universities.refresh_tokens_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY users.refresh_tokens
    ADD CONSTRAINT reshresh_tokens_max_user_data_id_fk FOREIGN KEY (max_user_id) REFERENCES users.max_users_data(id);
