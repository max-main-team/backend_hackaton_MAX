...
ALTER TABLE ONLY personalities.teachers
    ADD CONSTRAINT teachers_max_user_id_ukey UNIQUE (max_user_id, university_id);
...
ALTER TABLE ONLY personalities.teachers
    ADD CONSTRAINT teacher_university_id_fk FOREIGN KEY (university_id) REFERENCES universities.universities_data(id);
...
CREATE TABLE universities.events (
                                                id bigint NOT NULL,
                                                university_id BIGINT NOT NULL,
                                                title text,
...
ALTER TABLE universities.events OWNER TO max_superuser;
ALTER TABLE universities.events ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME universities.events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY universities.events
    ADD CONSTRAINT universities_events_pkey PRIMARY KEY (id);
